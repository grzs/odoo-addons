...
function isOdooObject(obj) {
    return (obj.otype !== undefined &&
        (obj.v !== undefined ||
            obj.vInt !== undefined ||
            obj.vFloat !== undefined ||
            obj.vBool !== undefined ||
            obj.vListStr !== undefined ||
            obj.vListInt !== undefined ||
            obj.vListFloat !== undefined));
}
...
const createOdooContext = (context) => {
    const oContext = [];
...
const extractOdooContext = (oContext) => {
    const context = {};
...
export { isOdooObject, createOdooContext, extractOdooContext, createOdooDomain, };
